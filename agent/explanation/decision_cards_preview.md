...
依据: 同节点HE14近30日Return偏正(+208.5)；负荷预测19333低于节点均值23481；近30日该小时波动±338(较高)；决策时spread_lag1处于历史21%分位；三模型一致性:conflict；同节点HE14历史样本n=910
...
RiskGate: PASS_WITH_WARNING(MODEL_DISAGREEMENT)
  RiskGate 说明: rule 与 ML 模型方向冲突，决策时点可见的方向不确定性硬信号。
风险: CONTROLX 为已知重尾节点，单笔尾部可达千级 $/MWh；CONTROLX SELL 存在 DA 崩塌尾（如 06-30 DA -1313），Risk Gate 不覆盖；近30日该小时波动较高(±338)
建议: 可考虑执行 SELL_DA，但需人工复核风险警告（MODEL_DISAGREEMENT）。
注意: 最终执行由交易员确认
...
依据: 同节点HE8近30日Return偏正(+271.0)；负荷预测23567接近节点均值23481；近30日该小时波动±401(很高)；决策时spread_lag1处于历史88%分位；三模型一致性:conflict；同节点HE8历史样本n=910
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: PASS_WITH_WARNING(MODEL_DISAGREEMENT)
  RiskGate 说明: rule 与 ML 模型方向冲突，决策时点可见的方向不确定性硬信号。
...
依据: 同节点HE2近30日Return偏正(+178.5)；负荷预测26177高于节点均值23481；近30日该小时波动±332(较高)；决策时spread_lag1处于历史61%分位；三模型一致性:conflict；同节点HE2历史样本n=919
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: PASS_WITH_WARNING(MODEL_DISAGREEMENT)
  RiskGate 说明: rule 与 ML 模型方向冲突，决策时点可见的方向不确定性硬信号。
...
依据: 同节点HE19近30日Return中性(+3.2)；负荷预测29900高于节点均值23481；近30日该小时波动±12(较低)；决策时spread_lag1处于历史58%分位；三模型一致性:仅单模型交易；同节点HE19历史样本n=882
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: PASS(NONE)
...
依据: 同节点HE7近30日Return中性(+6.7)；负荷预测23217接近节点均值23481；近30日该小时波动±12(较低)；决策时spread_lag1处于历史62%分位；三模型一致性:仅单模型交易；同节点HE7历史样本n=882
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: PASS(NONE)
建议: 可按模型建议执行 SELL_DA（Risk Gate PASS）。
注意: 最终执行由交易员确认
...
依据: 同节点HE20近30日Return中性(+3.2)；负荷预测32154高于节点均值21686；近30日该小时波动±13(较低)；决策时spread_lag1处于历史79%分位；三模型一致性:3/3 一致；同节点HE20历史样本n=92
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
...
依据: 同节点HE1近30日Return偏正(+193.3)；负荷预测24763高于节点均值23481；近30日该小时波动±349(较高)；决策时spread_lag1处于历史8%分位；三模型一致性:2/3 一致；同节点HE1历史样本n=911
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
...
依据: 同节点HE14近30日Return中性(-5.4)；负荷预测35910高于节点均值23481；近30日该小时波动±33(较低)；决策时spread_lag1处于历史56%分位；三模型一致性:仅单模型交易；同节点HE14历史样本n=944
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: PASS(NONE)
...
依据: 同节点HE3近30日Return偏正(+125.0)；负荷预测26521高于节点均值23481；近30日该小时波动±387(较高)；决策时spread_lag1处于历史11%分位；三模型一致性:仅单模型交易；同节点HE3历史样本n=924；来源模型=interpretable
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
...
依据: 同节点HE19近30日Return偏正(+124.7)；负荷预测28645高于节点均值23481；近30日该小时波动±309(较高)；决策时spread_lag1处于历史4%分位；三模型一致性:2/3 一致；同节点HE19历史样本n=910；来源模型=interpretable
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: REJECT(BUY_ON_POSITIVE_DRIFT_NODE)
  RiskGate 说明: CONTROLX 无条件漂移 +9.68，BUY 逆漂移且尾极深（train+val 验证，见 risk_gate_design R7a）。
...
依据: 同节点HE5近30日Return偏正(+45.2)；负荷预测22386低于节点均值23481；近30日该小时波动±273(较高)；决策时spread_lag1处于历史20%分位；三模型一致性:2/3 一致；同节点HE5历史样本n=906；来源模型=interpretable
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: REJECT(BUY_ON_POSITIVE_DRIFT_NODE)
  RiskGate 说明: CONTROLX 无条件漂移 +9.68，BUY 逆漂移且尾极深（train+val 验证，见 risk_gate_design R7a）。
...
依据: 同节点HE20近30日Return偏负(-50.4)；负荷预测40537高于节点均值21686；近30日该小时波动±156(中等)；决策时spread_lag1处于历史0%分位；三模型一致性:2/3 一致；同节点HE20历史样本n=141；来源模型=interpretable
Evidence: 全部 UNCERTAIN（8 类数据源未接入：CAISO_MARKET_NOTICE, EXTREME_WEATHER, FUEL_PRICE, LOAD_FORECAST_REVISION, OTHER, OUTAGE_AND_CONSTRAINT, RENEWABLE_GENERATION, WILDFIRE）；未发现可核实的外部事件
RiskGate: REJECT(LOW_SAMPLE_SUPPORT)
